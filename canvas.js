...
function implementSave() {
    ...
    actual_save_str_arr[0] = parseInt(actual_save_str_arr[0])
    actual_save_str_arr[1] = parseInt(actual_save_str_arr[1])
    actual_save_str_arr[2] = parseInt(actual_save_str_arr[2])
